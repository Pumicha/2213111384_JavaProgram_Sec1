...
public class Example1202 {
	...
	public static void showListStudent(int sec) throws IOException {
		...
		while ((temp = read.readLine()) != null) {
			...
			String resultGrade = findresult(midterm, finalScore);
			if (Integer.parseInt(data[3]) == sec) {
				System.out.println(data[0] + " " + data[2] + "\t" + midterm + "\t" + finalScore + "\t" + resultGrade);
			}
	...
	public static void Header(int sec) throws IOException {
		System.out.println("*****************************************************");
